...
func agentBrief() brief {
	...
	return brief{
		...
		Inspect: []string{
			...
			"crofty doctor --json     — check the built ./dist against the output contract (the gate before deploy), plus selfUpdate: whether `crofty update` will work from this install (route, writable)",
		},
		Notes: []string{
